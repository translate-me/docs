...
| Objetivo de medição | Apontar o aproveitamento de padrões de projeto durante o desenvolvimento da plataforma |
|---|---|
| Entidade | Disciplina |
...
| Análise | Medir a qualidade e a quantidade de padrões feitos pela equipe |
...
<table>
  ...
  <tr>
    <td colspan="2">
        <p>1. Maior quantidade de padrões aplicados ao projeto</p>
        <p>2. Maior aproveitamento dos padrões aplicados</p>
